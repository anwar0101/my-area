    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            ...
            if (transaction == Geofence.GEOFENCE_TRANSITION_ENTER && geofence.getRequestId().equals(Constants.GEOFENCE_ID_STAN_UNI)) {
                ...
                Toast.makeText(this, "You are inside Stanford University", Toast.LENGTH_LONG).show();
            } else {
                Log.d(TAG, "You are outside Stanford University");
                Toast.makeText(this, "You are outside Stanford University", Toast.LENGTH_LONG).show();
            }
        }
    }
}
